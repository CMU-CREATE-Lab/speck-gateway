 ...
 */
public final class RemoteStorageCredentialsImpl implements RemoteStorageCredentials
   {
   @NotNull
   ...
   public RemoteStorageCredentialsImpl(@NotNull final String hostName,
                                       final int hostPort,
   ...
   public boolean equals(final Object o)
      ...
      final RemoteStorageCredentialsImpl that = (RemoteStorageCredentialsImpl)o;
   ...
   public String toString()
      ...
      sb.append("RemoteStorageCredentialsImpl");
