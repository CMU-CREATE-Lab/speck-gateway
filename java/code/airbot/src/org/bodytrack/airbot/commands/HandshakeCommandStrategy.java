...
public final class HandshakeCommandStrategy extends CreateLabSerialDeviceHandshakeCommandStrategy
   {
   /** The pattern of characters to look for in the AirBot's startup mode "song" */
   private static final byte[] STARTUP_MODE_SONG_CHARACTERS = {'A', 'B'};

   /** The pattern of characters to send to put the AirBot into receive mode. */
   private static final byte[] RECEIVE_MODE_CHARACTERS = {'A', 'B'};
